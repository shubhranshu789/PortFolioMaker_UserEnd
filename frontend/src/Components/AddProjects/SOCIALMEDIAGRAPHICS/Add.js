...
function Add() {
    ...
    const loadFile = (event) => {
      ...
      const post = () => {
        if (Name == "") {
          notifyA("Please enter a name of the Graphics");
        } else if (Desc == "") {
          notifyA("Please enter a Desc of the Graphics");
        }
  ...
  return (
    <div>
      ...
      <h3 className="productInfo-heading">Add a New Graphics</h3>
      ...
      <div className="appProduct">
        ...
        <div className="productInfo">
          <div className="ap-input-container">
            <label htmlFor="">Graphics Name</label>
            <input
              type="text"
              className=""
              placeholder="Graphics name"
              value={Name}
              onChange={(e) => {
          ...
          <div className="ap-input-container">
            <label htmlFor="">Graphics Link</label>
            <input
              type="text"
              className=""
              placeholder="Graphics Link"
              value={Link}
              onChange={(e) => {
          ...
          <div className="ap-input-container">
            <label htmlFor="">Graphics Identity Description</label>
