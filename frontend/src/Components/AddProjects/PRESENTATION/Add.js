...
function Add() {
    ...
    const loadFile = (event) => {
      ...
      const post = () => {
        if (Name == "") {
          notifyA("Please enter a name of the Presentation");
        } else if (Desc == "") {
          notifyA("Please enter a Desc of the Presentation");
        }
  ...
  return (
    <div>
      ...
      <h3 className="productInfo-heading">Add a New Presentation</h3>
      ...
      <div className="appProduct">
        ...
        <div className="productInfo">
          <div className="ap-input-container">
            <label htmlFor="">Presentation Name</label>
            <input
              type="text"
              className=""
          ...
          <div className="ap-input-container">
            <label htmlFor="">Presentation Link</label>
            <input
              type="text"
              className=""
          ...
          <div className="ap-input-container">
            <label htmlFor="">Presentation Identity Description</label>
