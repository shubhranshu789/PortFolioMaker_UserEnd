...
function Add() {
    ...
    const loadFile = (event) => {
      ...
      const post = () => {
        if (Name == "") {
          notifyA("Please enter a name of the UI Design");
        } else if (Desc == "") {
          notifyA("Please enter a Desc of the UI Design");
        }
  ...
  return (
    ...
    <h3 className="productInfo-heading">Add a New UI Design</h3>
    ...
    <div className="appProduct">
      ...
      <div className="productInfo">
        <div className="ap-input-container">
          <label htmlFor="">UI Design Name</label>
          <input
            type="text"
            className=""
            placeholder="UI Design name"
            value={Name}
            onChange={(e) => {
        ...
        <div className="ap-input-container">
          <label htmlFor="">UI Design Link</label>
          <input
            type="text"
            className=""
            placeholder="UI Design Link"
            value={Link}
            onChange={(e) => {
        ...
        <div className="ap-input-container">
          <label htmlFor="">UI Design Identity Description</label>
